            ...
            @email_campo_invalido
            Esquema do Cenário: Email e Campo Inválido Checkout
            #Dado que eu acesse a plataforma EBAC-SHOP
            Quando eu preencher o Checkout com as informaçoes <nome> e <sobrenome> e <pais> e <endereco> e <cidade> e <cep> e <telefone>
            ...
            Exemplos:
            | nome   | sobrenome | pais   | endereco     | cidade         | cep       | telefone       | email              |
            | Joao   | Pessoa    |        | Rua Vermelha | Rio de Janeiro | 21999-000 | 21 99213-0034  | as@gmail.com       |
            | Rafael | Fernandes | Brasil |              | São Paulo      | 08090-284 | 11 98789 -0021 | rafaelf@outlook.   |
            | Carlos | Silva     | Brasil | Rua Azul     | Barueri        | 01419-002 |                | carlos@terra.cm.br |
